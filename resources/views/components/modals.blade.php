                ...
                <form id="house-form">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-4">
                            ...
                            <select class="form-select" id="extras" name="extras" required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-2">
                            ...
                            <input type="number" class="form-control" id="dormitorios" name="dormitorios" min="1" max="5" step="1" required>
                        </div>
                        <div class="col-2">
                ...
                <form id="house-search-form">
                    ...
                    <div class="row mb-3">
                        <div class="col-3">
                            <label for="dormitorios" class="form-label">Dormitorios</label>
                            <div class="d-flex">
                                <select class="form-select w-50 m-1" id="dormitorios-operator" name="dormitorios-operator">
                                    <option value="<"><</option>
                                    <option value="<="><=</option>
                                    <option value="=">=</option>
                                    <option value=">=">>=</option>
                                ...
                                <input type="number" class="form-control m-1" id="dormitorios" name="dormitorios" min="1" max="5" step="1">
                            </div>
                        </div>
                        <div class="col-3">
                            <label for="tamano" class="form-label">Tamaño</label>
                        ...
                        <div class="col-6">
                            ...
                            <div class="d-flex">
                                ...
                                <input type="number" class="form-control m-1" id="precio" name="precio" min="1" step="1">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
